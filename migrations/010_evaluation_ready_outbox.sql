...
-- SQLite CHECK constraints are immutable. Rebuild the durable outbox so a
-- READY evaluation is announced independently from the FINAL interview event.
CREATE TABLE outbox_events_v10 (
...
ALTER TABLE outbox_events_v10 RENAME TO outbox_events;
