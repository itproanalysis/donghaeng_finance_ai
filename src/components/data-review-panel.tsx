...
export function DataReviewContent({ review, compact = false, embedded = false }: { review: DataReview; compact?: boolean; embedded?: boolean }) {
  ...
  const sections = [["trace", "원문과 정리 내용"], ["features", "Feature Explorer"], ["signals", "개선가능성 근거"]];
