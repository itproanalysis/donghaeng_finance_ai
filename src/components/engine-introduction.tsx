...
export function EngineHome() {
  return <main id="main-content" className={styles.page}>
    ...
    <section className={styles.handoff}><h2>결과를 금융기관에 설명할 자료로</h2><p>사업 현황, 변수별 근거, 선택한 개선 계획과 실행 기록을 한 준비서에 담습니다. 부족한 자료를 확인하고 상담할 기관의 공식 안내로 이어갈 수 있습니다.</p><div className={styles.actions}><Link href="/review">내 결과에서 상담 준비 <ArrowRight size={17} /></Link><Link href="/about#consultation">상담 경로 살펴보기</Link></div><p className={styles.small}>준비서는 직접 내려받아 이용합니다. 제휴 기관 접수나 자동 전송 기능은 제공하지 않습니다.</p></section>
