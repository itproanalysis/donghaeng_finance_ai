...
export const SOHO_SCENARIO_FIXTURES: readonly SohoScenarioFixture[] = [
  ...
  fixture({
    ...
    industry: "미용",
    transcript: [
      { currentInfoCode: "essential_household_expenses", text: "월 필수 가계지출 답변을 거부하겠습니다.", expectedStatus: "REFUSED" },
      { currentInfoCode: "emergency_buffer_months", text: "비상자금도 답변을 거부하겠습니다.", expectedStatus: "REFUSED" },
    ],
    expectedStateTransitions: [
      transition("essential_household_expenses", "NEEDED", "REFUSED"),
      transition("emergency_buffer_months", "NEEDED", "REFUSED"),
    ],
    expectedFeatures: [
  ...
  fixture({
    ...
    industry: "운송",
    transcript: [
      { currentInfoCode: "essential_household_expenses", text: "월 필수 가계지출은 잘 모르겠습니다.", expectedStatus: "UNAVAILABLE" },
      { currentInfoCode: "emergency_buffer_months", text: "필수 생활비를 몇 달 감당하는지 잘 모르겠습니다.", expectedStatus: "UNAVAILABLE" },
    ],
    expectedStateTransitions: [
      transition("essential_household_expenses", "NEEDED", "UNAVAILABLE"),
      transition("emergency_buffer_months", "NEEDED", "UNAVAILABLE"),
    ],
    expectedFeatures: [
      { name: "essential_living_expense", state: "MISSING" },
      { name: "buffer_months", state: "MISSING" },
