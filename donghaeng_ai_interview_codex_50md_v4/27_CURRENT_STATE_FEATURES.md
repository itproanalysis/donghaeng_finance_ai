...
## 목적
현재 사업상태를 원천 피쳐로 구조화한다.

## 핵심 개발 지시
- business_tenure_months
- sales_slope_3m/sales_cv_6m/season_adjusted_sales_delta
- fixed_cost_ratio/cashflow_mismatch_days
- repeat_customer_share/channel_hhi
- shock_present/weeks_to_recovery

## 구현 메모
raw/normalized/source/verification을 모두 저장한다.
