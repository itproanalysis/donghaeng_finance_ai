...
## 목적
낙관적 발언이 아닌 수요 가시성으로 전망을 수치화한다.

## 핵심 개발 지시
- confirmed_order_value
- booking_coverage_weeks
- pipeline_value/coverage
- repeat_demand_share/contracted_revenue_share
- season_adjusted_growth
- demand_visibility/channel diversification

## 구현 메모
‘좋아질 것 같다’ 단독 발언은 점수 근거가 아니다.
