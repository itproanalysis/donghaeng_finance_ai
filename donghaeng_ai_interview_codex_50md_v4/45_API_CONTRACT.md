...
## 목적
음성·실시간 인터뷰·평가 API를 분리한다.

## 핵심 개발 지시
- POST/GET interviews
- POST messages
- GET SSE events/information-items/live-features
- POST complete
- WS audio
- GET interview-evaluations/pillars/goals/evidence

## 구현 메모
OpenAPI와 WS/SSE event spec을 문서화한다.
