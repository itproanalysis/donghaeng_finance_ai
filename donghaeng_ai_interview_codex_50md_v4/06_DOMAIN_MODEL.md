...
## 목적
실시간 상태와 평가 결과를 연결하는 엔티티를 정의한다.

## 핵심 개발 지시
- Borrower, BusinessProfile, CBSnapshot
- InterviewSession, RequiredInformationItem
- TranscriptSegment, InformationValue, LiveFeature
- InterviewFinalSnapshot, InterviewEvaluation, EvaluationPillar
- GoalSnapshot, EvidenceRef, AuditEvent

## 구현 메모
평가값에서 인터뷰 발화까지 역추적 가능해야 한다.
