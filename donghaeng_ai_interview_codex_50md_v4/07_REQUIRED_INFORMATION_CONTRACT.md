...
## 목적
인터뷰가 무엇을 수집해야 하는지 명시적 API 계약으로 받는다.

## 핵심 개발 지시
- info_code, category, priority, expected_type
- required, min_quality, evidence_preference
- dependencies, current_status
- Pydantic/JSON Schema validation

## 구현 메모
필요정보 목록 없이 LLM이 임의 범용 인터뷰를 시작하지 않는다.
