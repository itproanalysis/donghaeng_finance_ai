# 13. 실시간 음성 전송 Protocol

## 목적
오디오와 STT 이벤트를 WebSocket으로 전달한다.

## 핵심 개발 지시
- WS /interviews/{id}/audio
- audio.start/pause/resume/end_turn/stop
- binary audio chunk
- stt.partial/stt.final/vad events
- audio_session_id와 sequence로 재연결

## 구현 메모
음성은 WebSocket, 업무상태는 SSE 분리를 권장한다.
